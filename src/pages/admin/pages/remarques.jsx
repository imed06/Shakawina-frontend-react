...
export default function Remarque() {
  ...
  useEffect(() => {
    const getComplains = async () => {
      try {
        const response = await fetch("http://localhost:4000/complaint/filter/remarque");
  ...
  return (
    <div className='h-screen flex justify-between'>
      ...
      <div className='flex flex-col items-center w-full h-full'>
        ...
        <div className='font-bold justify-start flex items-start text-xl ml-3'>Dashboard / Remarques</div>

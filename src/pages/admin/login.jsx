...
export default function LoginAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        const hasEmptyField = _.some(userData, value => value === '');
        ...
        <div className='h-screen items-center admin'>
            <div className='h-full justify-center items-center flex flex-col'>
                ...
                <Input
                    ...
                    variant="bordered"
                    className="max-w-lg"
                    validationState={username === "" && empty && 'invalid'}
                    onChange={(e) => {
                        setEmpty(false)
                ...
                />
                <Spacer y={8} />
                <div className="flex py-2 px-1 justify-between w-full max-w-lg">
                    <Checkbox
                        classNames={{
                            label: "text-small",
                        }}
                ...
                <Spacer y={8} />
                {
                    isLoading ?
                        <Spinner />
                        :
                        <Button color="primary" className=' max-w-xs w-full text-xl font-medium' onClick={handleSubmit}>
                            Connexion
                        </Button>
                }
            </div>
